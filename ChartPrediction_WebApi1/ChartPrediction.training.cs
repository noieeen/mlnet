...
using Microsoft.ML.Data;
    ...
    {
        public const string RetrainConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\Video\Video\DailyDemand.mdf;Integrated Security=True;Connect Timeout=30";
        public const string RetrainCommandString = @"SELECT [RentalDate], CAST([Year] as REAL), CAST([TotalRentals] as REAL) FROM [dbo].[Rentals]";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:34,seriesLength:423,trainSize:731,horizon:7,outputColumnName:@"TotalRentals",inputColumnName:@"TotalRentals",confidenceLowerBoundColumn:@"TotalRentals_LB",confidenceUpperBoundColumn:@"TotalRentals_UB");
